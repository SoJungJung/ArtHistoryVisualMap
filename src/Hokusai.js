    ...
    <div className="container">
      ...
      {pageVisible && (
        <>
          ...
          <p className="bio">
            My art practice is different from what Hokusai did. I have never tried printing or ukiyo-e art before. I,
            however, am interested in how to make my art pieces as a meme that survives through centuries.
          </p>
          ...
          <p className="exm">
            Although I seldom drew landscapes like Hokusai, I drew simulated island landscapes. This piece was drawn
            after the pillows and a blanket on my bed. It is not colorful or energetic like Hokusai's work, nor
            recognized as a masterpiece, but it is a piece that I can relate to, and my mom likes mine more.^^
          </p>
          <p className="rlt"></p>
